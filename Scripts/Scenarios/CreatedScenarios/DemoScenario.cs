...
public class DemoScenario : Scenario
{
	...
	public DemoScenario(Image mapTexture)
	{
		...
		Map = new ProvinceData[14]
		{
			...
			new ProvinceData(6,  Countries["France"], "Rekyavik", Terrain.Plain, Good.Iron, 2, new float[] {3, 0}, new List<Building>(), Modifiers.DefaultModifiers(), new ArmyUnitData("test", Countries["Great Britian"], 1)),
			...
			new ProvinceData(9,  Countries["Sweden"], "Rekyavik", Terrain.Mountains, Good.Wheat, 1, new float[] {5, 0}, new List<Building>(), Modifiers.DefaultModifiers(), new ArmyUnitData("test", Countries["Great Britian"], 1)),
			...
			new ProvinceData(11, Countries["Sweden"], "Rekyavik", Terrain.Mountains, Good.Wheat, 1, new float[] {0, 6}, new List<Building>(), Modifiers.DefaultModifiers(), new ArmyUnitData("test", Countries["Great Britian"], 1)),
